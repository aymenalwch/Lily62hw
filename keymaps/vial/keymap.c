...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //,-----------------------------------------------------|                                |-----------------------------------------------------|
      ...
      KC_LSFT,    KC_Z,    KC_X,    KC_C,    KC_V,    KC_B, LT(3,KC_LBRC),    LT(3,KC_RBRC),    KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH, RSFT_T(KC_BSLS),
               KC_LCTL, KC_LGUI, KC_LALT,  KC_SPC,   MO(2),         MO(1),    LT(1,KC_PSCR),  KC_ENT, KC_BSPC, RALT_T(KC_DEL), KC_RGUI, KC_RCTL
            //|-------------------------------------------|                                |-----------------------------------------------------|
  ),
    [1] = LAYOUT_7x5(
//,-----------------------------------------------------|                    |-----------------------------------------------------|
      ...
      KC_LSFT, XXXXXXX, KC_WH_L, XXXXXXX, KC_WH_R, XXXXXXX, _______,    _______, KC_HOME, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
               KC_LCTL, KC_LGUI, KC_LALT,  KC_SPC, _______, _______,    _______,  KC_ENT, KC_BSPC,  KC_DEL, KC_RGUI, KC_RCTL
//|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
  ),
    [2] = LAYOUT_7x5(
  //,-----------------------------------------------------|                    |-----------------------------------------------------|
